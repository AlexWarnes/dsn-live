...
export const spacecraftMap = {
	...
	143: {
		...
		sources: [
			...
			},
			{
				...
				url: 'https://www.esa.int/Science_Exploration/Human_and_Robotic_Exploration/Exploration/ExoMars/Trace_Gas_Orbiter_instruments'
			}
		]
	} as Spacecraft,
	74: {
	...
	21: {
		...
		sources: [
			...
			{
				title: 'Solar and Heliospheric Observatory, European Space Agency (ESA)',
				url: 'https://www.esa.int/Science_Exploration/Space_Science/SOHO_overview2'
			},
			{
	...
	1: {
		...
		sources: [
			...
			},
			{
				...
				url: 'http://www.isas.jaxa.jp/en/missions/spacecraft/current/geotail.html'
			},
			{
	...
	199: {
		...
		sources: [
			...
			},
			{
				...
				url: 'https://www.esa.int/Science_Exploration/Space_Science/Integral_overview'
			}
		]
	} as Spacecraft,
	5: {
	...
	135: {
		...
		sources: [
			...
			{
				title: 'Double Asteroid Redirection Test, Johns Hopkins Applied Physics Laboratory',
	...
	49: {
		...
		sources: [
			{
				title: 'Lucy, Wikipedia',
				url: 'https://en.wikipedia.org/wiki/Lucy_(spacecraft)'
			},
			{
				title: 'Lucy in Depth, NASA Science',
				url: 'https://solarsystem.nasa.gov/missions/lucy/in-depth/'
			},
			{
				title: 'Lucy, SWRI',
				url: 'http://lucy.swri.edu/'
			}
		]
	} as Spacecraft,
	170: {
		id: '170',
		shortName: 'JWST',
		longName: 'James Webb Space Telescope',
		sources: [
			{
				title: 'JWST, Wikipedia',
				url: 'https://en.wikipedia.org/wiki/James_Webb_Space_Telescope'
			},
			{
				title: 'JWST in Depth, NASA Science',
				url: 'https://solarsystem.nasa.gov/missions/james-webb-space-telescope/in-depth/'
			},
			{
				title: 'JWST, European Space Agency (ESA)',
				url: 'https://sci.esa.int/web/jwst'
			},
			{
				title: 'JWST, Canadian Space Agency (CSA)',
				url: 'https://www.asc-csa.gc.ca/eng/satellites/jwst/about.asp'
			},
			{
				title: 'JWST Home, NASA',
